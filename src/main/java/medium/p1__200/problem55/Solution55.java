package medium.p1__200.problem55;
...
public class Solution55 {
    ...
    public static boolean canJumpTest(int[] nums) {
        Solution55.Solution2 solution2 = new Solution55.Solution2();
        return solution2.canJump(nums);
    }
    ...
    public static void main(String[] args) {
        ...
        assertEquals(false, canJumpTest(nums));

        nums = new int[] {1, 2};
        assertEquals(true, solution2.canJump(nums));
        assertEquals(true, canJumpTest(nums));
