...
Если значение начинается с 4 или 9, используйте вычитательную форму, представляющую один символ, вычитаемый из следующего символа, например, 4 - это 1 (I) меньше, чем 5 (V): IV, а 9 - это 1 (I) меньше, чем 10 (X): IX. Только следующие вычитательные формы могут использоваться используемые размеры: 4 (IV), 9 (IX), 40 (XL), 90 (XC), 400 (CD) и 900 (CM).
