...
Определите, подходит ли доска для судоку размером 9 х 9. Только заполненные ячейки должны быть проверены в соответствии со следующими правилами:
...
Каждая из девяти ячеек сетки размером 3 х 3 должна содержать цифры от 1 до 9 без повторений.
Примечание:
