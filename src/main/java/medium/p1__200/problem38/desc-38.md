...
Последовательность подсчета и произнесения представляет собой последовательность цифровых строк, определяемую рекурсивной формулой:

countAndSay(1) = "1"
countAndSay(n) - это кодировка длины выполнения countAndSay(n - 1).
