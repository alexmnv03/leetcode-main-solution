...
Вам предоставляется массив непересекающихся интервалов intervals, где интервалы[i] = [starti, endi] представляют начало и конец i-го интервала, а интервалы отсортированы в порядке возрастания по starti. Вам также будет задан интервал newInterval = [начало, конец], который представляет начало и конец другого интервала.
