package easy.p1__200.problem169;

import static org.junit.Assert.assertEquals;

public class Solution169 {

    public static int majorityElementTest(int[] nums) {
        return majorityElement(nums);
    }

    public static void main(String[] args) {
        int[] nums1 = new int[] {1, 3, 1, 1, 4, 1, 1, 5, 1, 1, 6, 2, 2};
        int[] nums2 = new int[] {3,2,3};
        int[] nums3 = new int[] {2,2,1,1,1,2,2};

        assertEquals(1, majorityElement(nums1));
        assertEquals(3, majorityElement(nums2));
        assertEquals(2, majorityElement(nums3));

        assertEquals(1, majorityElementTest(nums1));
        assertEquals(3, majorityElementTest(nums2));
        assertEquals(2, majorityElementTest(nums3));
    }
